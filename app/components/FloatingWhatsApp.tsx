...
const FloatingWhatsApp = () => {
  ...
  const phoneNumber = "447398145581";
    ...
    <div className="fixed bottom-6 right-6 z-50">
      ...
      {showTooltip && !isHovered && (
        <motion.div
          ...
          exit={{ opacity: 0, x: 20 }}
          className="absolute bottom-16 right-0 bg-gray-900 text-white px-4 py-2 rounded-lg shadow-lg whitespace-nowrap text-sm font-medium"
        >
      ...
      <motion.a
        ...
        whileTap={{ scale: 0.95 }}
        className="relative flex items-center justify-center w-14 h-14 bg-green-500 rounded-full shadow-xl hover:bg-green-600 transition-colors"
      >
        {/* WhatsApp Icon */}
        <svg
        ...
        {/* Message Badge */}
        <div className="absolute -top-1 -right-1 w-5 h-5 bg-red-500 rounded-full flex items-center justify-center text-white text-[10px] font-bold border-2 border-white shadow-md">
          1
        </div>
      </motion.a>
    </div>
