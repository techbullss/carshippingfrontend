          ...
          <div className="flex items-center gap-3 pt-1">
            {socials.map((s) => (
              <a
                ...
                href="#"
                aria-label={s.label}
                className="w-8 h-8 flex items-center justify-center rounded-full bg-gray-800 text-gray-400 hover:bg-yellow-500 hover:text-gray-900 transition-colors duration-200"
              >
        ...
        >
          ...
          <ul className="space-y-3 text-sm">
            {[
              ...
              <li key={h.day} className="flex justify-between border-b border-gray-800 pb-2">
                <span className="text-gray-400">{h.day}</span>
                <span
                  className={`font-medium ${
                    h.time === "Closed" ? "text-gray-500" : "text-yellow-400"
                  }`}
                >
                  {h.time}
                </span>
        ...
        >
          ...
          <ul className="space-y-4 text-sm">
            ...
            <li className="flex gap-3 items-start">
              <svg className="w-4 h-4 mt-0.5 text-yellow-400 flex-shrink-0" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
            ...
            <li className="flex gap-3 items-center">
              ...
              <a href="tel:+447398145581" className="text-gray-400 hover:text-yellow-400 transition-colors duration-200">
                +44 7398 145581
              </a>
            </li>
            ...
            <li className="flex gap-3 items-center">
              ...
              <a href="mailto:info@f-carshipping.com" className="text-gray-400 hover:text-yellow-400 transition-colors duration-200">
      ...
      <div className="max-w-7xl mx-auto px-6 py-5 flex flex-col md:flex-row items-center justify-between gap-3 text-xs text-gray-500">
        ...
        <div className="flex gap-5">
          {["Privacy Policy", "Terms of Service", "Cookie Policy"].map((p) => (
            <a key={p} href="#" className="hover:text-yellow-400 transition-colors duration-200">
              {p}
            </a>
          ))}
        </div>

        <span className="text-gray-600">Est. UK · Nationwide Service</span>
      </div>
    </footer>
  );
}